...
- **자기겹침 지도.** 스윕(§7b)이 판정하는 유일한 기준이므로 남은 자리를 여기 적어 둔다. 측정 2026-09-05, 손을 rest에 묶고 전신 무작위 20,000 + 쌍 1,012 + 단독 184, seed 1, **첫 보정(gate) 여유 0**(`512d81a`; 여유 38 mm의 전신은 아직 재지 않았다 — 1·2층은 케이스 수가 같고 쇄골 무리의 삼각형만 5 → 7로 올랐다). **단독은 실패 0**, 쌍은 7건(쇄골 4 · 골반 3), 전신은 **2,837 / 20,000**(보정 전 5,277). 보정이 목이 가라앉아 생기던 것을 함께 닫아 A는 −60%~전멸, B −84%, C −71%이고 **남은 것의 대부분이 D**다.
    ...
    | 기전 | 그룹(케이스) | 방아쇠 | 뿌리 |
    |---|---|---|---|
    | **D 골반·다리 폭** | `spine+spine mid+spine1` 1,670 · `L/R hip+L/R knee` 1,023·1,058 · `ankle+knee` 762 · `knee+crotch` 484 · `L ankle+L toe` 2 (2026-09-07) | 고관절 뼈 0.5(단독은 무사, pelvis나 반대쪽과 겹치면 깨진다) | 고관절 기둥만 뼈를 (1+f)배로 따라간다. `L hip=0.5`에서 그 기둥이 side 0.1809 → 0.0905로 걸어 들어오는데 spine 링의 변은 0.1635, 무릎 링은 rest 폭에 그대로 남는다 — 골반 판의 변이 꺾이고 허벅지 판의 옆변이 뒤집힌다. `[N16]`이 **높이**는 닫았지만 **폭**은 열려 있다. 두께 driver와 같은 뿌리이고, 다음 gate의 후보다. **2026-09-07 스윕에서 남은 자기겹침은 이 무리뿐이다** — 전신 2,099 / 20,000, 1·2층 3건 |
